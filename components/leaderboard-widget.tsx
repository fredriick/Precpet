  ...
  const header = (
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{t("leaderboard.title")}</h3>
      </div>
      <span className="text-xs text-muted-foreground">{t("challenges.thisWeek")}</span>
    </div>
  )
    ...
    <div className="rounded-2xl bg-card border border-border p-5">
      ...
      {user && (
        <div className="mb-3 rounded-xl bg-primary/10 border border-primary/25 px-3 py-2 text-center">
          <p className="text-xs text-muted-foreground">{t("leaderboard.yourRank")}</p>
          ...
          <>
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-xl bg-primary/15 border border-primary/30">
              ...
              <p className="flex-1 min-w-0 truncate text-sm font-semibold">
                {user.name}
                <span className="text-primary text-xs ml-1">{t("club.you")}</span>
              </p>
