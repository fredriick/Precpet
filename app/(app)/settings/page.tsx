    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="px-4 py-6 max-w-lg md:max-w-5xl mx-auto space-y-6">
        ...
        <section className="rounded-2xl bg-card border border-border p-5">
          <h2 className="font-semibold mb-1">{t("settings.preferredSports")}</h2>
          <p className="text-xs text-muted-foreground mb-4">{t("settings.preferredSportsDesc")}</p>
        ...
        {settings.preferredSports.length > 1 && (
          <section className="rounded-2xl bg-card border border-border p-5">
            <h2 className="font-semibold mb-1">{t("settings.activeSport")}</h2>
            <p className="text-xs text-muted-foreground mb-4">{t("settings.activeSportDesc")}</p>
            <div className="flex gap-2">
        ...
        <section className="rounded-2xl bg-card border border-border p-5">
          <h2 className="font-semibold mb-1">{t("settings.preferredDifficulty")}</h2>
          <p className="text-xs text-muted-foreground mb-4">{t("settings.preferredDifficultyDesc")}</p>
          <div className="flex flex-wrap gap-2">
            {difficulties.map((diff) => (
              ...
              >
                {diff === "all" ? t("settings.allLevels") : diff.charAt(0).toUpperCase() + diff.slice(1)}
              </button>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-2xl bg-card border border-border p-5">
          <div className="flex items-center justify-between mb-1">
            <h2 className="font-semibold">{t("settings.weeklyGoal")}</h2>
          ...
          <p className="text-xs text-muted-foreground mb-4">{t("settings.weeklyGoalDesc")}</p>
          <div className="flex flex-wrap gap-2">
        ...
        {/* Theme Toggle */}
        <section className="rounded-2xl bg-card border border-border p-5">
          <h2 className="font-semibold mb-1">{t("settings.appearance")}</h2>
        ...
        <section className="rounded-2xl bg-card border border-border p-5">
          ...
          <div className="flex gap-2">
            {SUPPORTED_LOCALES.map((locale: Locale) => (
              <button
                key={locale}
                onClick={() => updateSettings({ language: locale })}
                className={cn(
                  "flex-1 py-3 rounded-xl text-sm font-medium transition-all border",
        ...
        {/* Sound & Haptics */}
        <section className="rounded-2xl bg-card border border-border p-5">
          <h2 className="font-semibold mb-4">{t("settings.soundFeedback")}</h2>
          <div className="space-y-4">
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                <p className="text-sm font-medium">{t("settings.haptic")}</p>
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                <p className="text-sm font-medium">{t("settings.reminders")}</p>
        ...
        {/* Data Management */}
        <section className="rounded-2xl bg-card border border-border p-5">
          <h2 className="font-semibold mb-1">{t("settings.dataPrivacy")}</h2>
          <p className="text-xs text-muted-foreground mb-4">{t("settings.dataPrivacyDesc")}</p>
          <Link
            href="/profile/export"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium">{t("settings.dataManagement")}</p>
